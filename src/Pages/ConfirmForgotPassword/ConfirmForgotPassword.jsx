...
export default function ConfirmForgotPassword() {
  ...
  const handleConfirmForgotPassword = async (e) => {
    ...
    const completed = await completeForgotPassword(
      userId,
      secret,
      password,
      confirmPassword
  ...
  return (
    <div className="sm:mt-0 mt-10 w-[80%] h-full flex items-center justify-center flex-col">
      <form
        ...
        <p
          className={`text-xs text-red-700 ${
            confirmPasswordHidden ? "block" : "hidden"
          } text-left w-full`}>
        ...
        <input
          ...
          disabled={confirmPasswordHidden && passwordHidden}
        />
      </form>
    </div>
  );
